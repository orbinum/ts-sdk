...
describe('EncryptedMemo.decrypt — ECDH round-trip', () => {
    ...
    it('recovered sourcePk matches original', () => {
        const enc = EncryptedMemo.encrypt(
            value,
            ownerPk,
            blinding,
    ...
    it('sourcePk is 0n when not provided', () => {
        const enc = EncryptedMemo.encrypt(
            value,
            ownerPk,
            blinding,
...
describe('EncryptedMemo.encrypt with ephSkOverride', () => {
    ...
    it('two calls with same ephSkOverride produce different nonces but same ephPk region', () => {
        const memoA = EncryptedMemo.encrypt(
            value,
            new Uint8Array(32),
            new Uint8Array(32),
            0,
        ...
        const memoB = EncryptedMemo.encrypt(
            value,
            new Uint8Array(32),
            new Uint8Array(32),
            0,
