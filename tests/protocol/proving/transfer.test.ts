...
import type { ArtifactProvider, ProofResult } from '../../../src/protocol/proving/transfer';
...
import { generateTransferProof, WebArtifactProvider } from '../../../src/protocol/proving/transfer';
