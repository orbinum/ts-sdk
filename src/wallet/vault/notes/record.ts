 ...
 *
 * The single place that decides what leaves the wallet in plaintext: the body
 * is sealed under the vault key, the identifiers become blind tags, and only
 * the local spend flags stay readable.
 */

import type { ZkNote } from '../../../protocol/types';
import { encryptJson, decryptJson, blindTag } from '../crypto/keys';
import type { EncryptedNoteRecord, NoteStatusUpdate } from '../storage/records';
